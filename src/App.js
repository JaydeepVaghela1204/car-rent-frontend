...
import CarTable from './components/landingBodyComponents/carTable';
import carDetail from './components/landingBodyComponents/carDetail'
...
import BookingConfirmDetailsPopUp from './components/bookingComponents/bookingConfirmDetails';
...
import ViewAllPaymentsPage from './components/staffComponents/viewAllPayments';
    ...
    return (
      <Router>
        ...
        <Switch>
          ...
          <Route path="/booking_confirm" component={BookingConfirmDetailsPopUp} />
          <Route path="/car_table" component={CarTable} />
          <Route path="/car_detail" component={carDetail} />
          ...
          <StaffRoute path="/admin/view/payment" component={ViewAllPaymentsPage} />
        </Switch>
        {/* <Footer /> */}
      </Router>
    );
