                ...
                {!this.state.errorMessage &&
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div>
                            ...
                            <b>User ID: </b> <a href={`/admin/view/customers/${this.state.booking.user}`}>{this.state.booking.user} </a><br></br>
                            <b>Booking time: </b> {new Date(this.state.booking.bookedtime).toLocaleString()} <br></br>
                            <b>Pickup time: </b> {new Date(this.state.booking.pickuptime).toLocaleString()} <br></br>
                            <b>Return time: </b> {new Date(this.state.booking.returntime).toLocaleString()} <br></br>
                        ...
                        <Col sm={4}>
                            <div className="cars-div-white" style={{ 'border': 'solid black 2px' }}>
                                {/* <img style={{ borderRadius: 0 }} src={this.state.car.image} alt="car" width="100" /> */}
