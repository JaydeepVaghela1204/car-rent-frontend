...
import { Button, Alert, Table, Form, Col, Row } from 'react-bootstrap'
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        <tr key={car._id}>
                            ...
                            <td>{car.fueltype}</td>
                            <td>{car.location}</td>
                            <td><img style={{ borderRadius:0}} alt="car" src={image[0]} width={50} />
                ...
                <h2 style={{ textAlign: "center" }}>Modify details</h2>
                {this.state.errMsg &&
