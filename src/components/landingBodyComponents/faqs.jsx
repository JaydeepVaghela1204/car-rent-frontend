        ...
        return (
            <section className="section-item">
                <div>
                    ...
                    <Accordion style={{ marginTop: '7vh',color:"black" }}>
                        ...
                        <AccordionCustom eventKey="5" question="Can I smoke in your cars?" answer="Smoking is prohibited and will incur a ₹3000 penalty if found guilty." />
                    </Accordion>
                    </div>
                </div>
            </section>
