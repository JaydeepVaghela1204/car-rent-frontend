                    ...
                    <Container fluid style={{ marginTop: '3vh' }}>
                        <Row>
                            ...
                            <Col>
                                <div className="how-it-works">
                                    <h3>Book</h3>
                                    <p>Checkout your nearest cars <a href="/dashboard">here</a>, then head over to dashboard, pick a time range to get started!</p>
                                </div>
                            </Col>
                            <Col>
                                <div className="how-it-works">
                        ...
                        <div className="benefits-div">
                            <h2>Benefits</h2>
                            <p>
                                Anonymous Car Share gives you access to cars 24/7 without the hassle of owning one.
                                You can rent a car from just ₹500 an hour, with fuel, insurance and Roadside assistance included.
                            </p>
